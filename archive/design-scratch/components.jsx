/* Shared UI primitives + the signature pill nav. Exported to window. */
...
function Placeholder({ tag, className = "" }) {
  return (
...
function SectionHead({ eyebrow, title, sub, meta }) {
  return (
...
/* ---- Pill nav with sliding frosted thumb ---- */
...
Object.assign(window, { NAV, Placeholder, Chips, SectionHead, PillNav });
